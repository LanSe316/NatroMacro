...
> [!CAUTION]
> We do **not** have a website. The only official place to  Natro Macro is this repository and [discord.gg/natromacro][discord-link].
...
1.  `Natro_Macro_v#.#.#.zip` from the [latest ][latest--link]
...
This is where you can connect with the community, access guides and help channels, and  custom patterns, paths, and themes!
